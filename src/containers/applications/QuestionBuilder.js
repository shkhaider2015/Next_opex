...
export default class SurveyQuestionBuilder extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            answerType: this.props.answerType ?
                answerTypes.find(item => item.id === this.props.answerType) :
                null,
  ...
  addAnswer = () => {
      ...
      if (this.state.answers.length > 0) {
          const orderedAnswers = this.state.answers.slice().sort((a, b) => a.id < b.id);
                          ...
                          <Form>
                              ...
                              <Sortable
                                  ...
                                  onChange={(order, sortable, evt) => {
                                      const answers = mapOrder(this.state.answers, order, 'id');
                                      this.setState({ answers });
                                  }}
                            >
